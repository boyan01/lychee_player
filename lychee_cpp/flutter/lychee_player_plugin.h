...
FFI_PLUGIN_EXPORT void *lychee_player_create(const char *file_path, int64_t send_port);

FFI_PLUGIN_EXPORT void lychee_player_dispose(void *player);

FFI_PLUGIN_EXPORT void lychee_player_set_play_when_ready(void *player, bool play_when_ready);
