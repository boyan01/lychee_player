...
#ifndef MEDIA_PLAYER_FFMPEG_FFMPEG_GLUE_H_
#define MEDIA_PLAYER_FFMPEG_FFMPEG_GLUE_H_
...
class FFmpegGlue {
 ...
 private:
  ...
  unique_ptr_d<AVIOContext> avio_context_;
...
#endif  // MEDIA_PLAYER_FFMPEG_FFMPEG_GLUE_H_
