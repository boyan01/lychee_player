...
double Clock::GetSpeed() const { return speed_; }

Clock *MediaClock::GetVideoClock() { return video_clock_.get(); }

Clock *MediaClock::GetAudioClock() { return audio_clock_.get(); }

Clock *MediaClock::GetExtClock() { return ext_clock_.get(); }
...
MediaClock::MediaClock(int *audio_queue_serial, int *video_queue_serial,
